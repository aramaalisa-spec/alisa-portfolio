...
heroImage: /uploads/yellow post-it L2.png
---
...
- Discover, collect, and centralise the crucial data points for every member application scenario;
- Identify patterns to foster a lean execution;
- Analyse, prototype, test, and iterate on user flows;
